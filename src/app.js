...
const inventario = ["hongo", "flor", "trampa", "estrella", "trampa", "pluma"];
...
const inventarioSinTrampas = inventario.filter(filtrado);
inventarioSinTrampas.push("super estrella");

function filtrado(item) {
  return item != "trampa";
}

for (let i = 0; i < inventarioSinTrampas.length; i++) {
  inventarioSinTrampas[i].toUpperCase();
}

const inventarioEnMayusculas = inventarioSinTrampas;
